...
namespace EAP_C2007L_NguyenDucHuy.Controllers
{
    public class GenresController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "GenreId,GenreName")] Genre genre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "GenreId,GenreName")] Genre genre)
        {
            if (ModelState.IsValid)
            {
