...
{
    public class DataInitializer : DropCreateDatabaseIfModelChanges<MyDbContext>
    {
        protected override void Seed(MyDbContext context)
        {
            ...
            {
new Album{AlbumId=01, Title="Twenty File", ReleaseDate=DateTime.Parse("2015-11-20"), Artist="Adele", GenreId= 1, Price = 9.99},
new Album{AlbumId=02, Title="Nineteen Eighty-Nine", ReleaseDate=DateTime.Parse("2014-10-27"), Artist="Taylor Swift", GenreId= 1, Price = 10.99},
new Album{AlbumId=03, Title="A million", ReleaseDate=DateTime.Parse("2016-09-30"), Artist="Bon Iver", GenreId= 2, Price = 9.99},
new Album{AlbumId=04, Title="Meteora", ReleaseDate=DateTime.Parse("2003-03-25"), Artist="Linkin Park", GenreId= 2, Price = 7.99},
new Album{AlbumId=05, Title="Nevermind", ReleaseDate=DateTime.Parse("1991-09-24"), Artist="Nivarna", GenreId= 2, Price = 9.99},
new Album{AlbumId=06, Title="To Pimp a Butterfly", ReleaseDate=DateTime.Parse("2015-03-15"), Artist="Kendrick Lamar", GenreId= 3, Price = 8.99},
new Album{AlbumId=07, Title="The Chronic", ReleaseDate=DateTime.Parse("1992-12-15"), Artist="Dr.Dre", GenreId= 3, Price = 9.99},
new Album{AlbumId=08, Title="Comes Away With Me", ReleaseDate=DateTime.Parse("2002-02-26"), Artist="Norah Jones", GenreId= 4, Price = 6.99},
new Album{AlbumId=09, Title="Kind of Blues", ReleaseDate=DateTime.Parse("1959-08-17"), Artist="Miles Davids", GenreId= 4, Price = 7.99},
